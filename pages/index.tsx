...
export default function Home() {
  return (
    ...
    <InformationSection title={"Clean Jobs"}
                        ...
                        description={"Ofertas de trabajo <b>curadas</b> según de la <b>metodolgía de trabajo y el feedback de los Clean Cloders</b> te mostramos los lugares donde el clean code y las buenas practicas son <b>indispensables</b>. <br /> <span class='is-size-5 mt-3'>Podes encontrar las mejores propuestas <span class=\"tag is-success\">JUNIOR FRIENDLY</span>"}
                        link={"/jobs"}
    />
